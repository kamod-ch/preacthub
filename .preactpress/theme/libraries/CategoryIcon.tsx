export function CategoryIcon({ slug }: { slug: string }) {
  ...
  switch (slug) {
    ...
    case "ai-infrastructure":
      return <svg {...common}><path d="M12 2l8 4.5v7L12 18l-8-4.5v-7L12 2z" /><path d="M12 12l8-4.5M12 12v6M12 12L4 7.5" /></svg>;
    case "agent-frameworks":
      return <svg {...common}><circle cx="12" cy="12" r="3" /><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" /></svg>;
    case "browser-automation":
      return <svg {...common}><rect x="3" y="5" width="18" height="14" rx="2" /><path d="M3 9h18M7 5V3M17 5V3" /></svg>;
    case "ai-developer-apis":
      return <svg {...common}><path d="M7 8h10v8H7z" /><path d="M12 8V5M9 5h6" /><path d="M10 16h4" /></svg>;
    default:
